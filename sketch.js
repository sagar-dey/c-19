...
function preload(){
  trex_running = loadAnimation("mi.jpg");
  trex_collided = loadImage("rhino.jpg");
  gameOverImg = loadImage("gameOver.png");
  restartImg = loadImage("restart.png");
  groundImage = loadImage("ground2.png");
 desertImg = loadImage("kz.jpg");
  
  cloudImage = loadImage("cloud.png");
  
  obstacle1 = loadImage("spfh.jpg");
  obstacle2 = loadImage("spfh.jpg");
  obstacle3 = loadImage("spfh.jpg");
  obstacle4 = loadImage("spfh.jpg");
  obstacle5 = loadImage("spfh.jpg");
  obstacle6 = loadImage("spfh.jpg");
  obstacle1.scale=0.5;
  obstacle2.scale=0.5;
  obstacle3.scale=0.5;
  obstacle4.scale=0.5;
